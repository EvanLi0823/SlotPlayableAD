...
export default class RightSidePanelController extends cc.Component {
    ...
    private updateDownloadButtonText(): void {
        if (this.downloadLabel) {
            ...
            cc.log(`[RightSidePanelController] Updated download label to: ${downloadText}`);
            ...
            if (label) {
                ...
                cc.log(`[RightSidePanelController] Updated download label (from child) to: ${downloadText}`);
            }
        }
    }
