/**
 * LeftSidePanelController - 左侧面板控制器
 * 管理左侧Icon和Download按钮
 */
...
@ccclass
export default class LeftSidePanelController extends cc.Component {
    @property(cc.Node)
    ...
    private handleDownloadClick(): void {
        cc.log("[LeftSidePanelController] Download button clicked");
